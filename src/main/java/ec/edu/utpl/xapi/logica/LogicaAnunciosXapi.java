...
public class LogicaAnunciosXapi {
    ...
    public boolean obtener_anuncios_xapi(int pdoid) {
        ...
        DBCollection collection = db.getCollection("anuncios");
        System.out.println("Seleccionando la Collection: anuncios");
        System.out.println("**********************************************");       
